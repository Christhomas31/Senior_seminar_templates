...
The results of the study are shown in figure 1.  The results were divided between a beginner group (students within their first few code classes) and a mature group (students nearing graduation and professionals).  In the results section Janzen concluded that beginner coding students have a preference toward test-last testing while more mature coding students and industry professionals show a preference toward test-first testing. 
